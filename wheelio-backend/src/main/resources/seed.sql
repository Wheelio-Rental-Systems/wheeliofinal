...
INSERT INTO vehicles (id, name, brand, type, price_per_day, location, status, image_url, features, description, seats, fuel_type, transmission, rating, reviews) VALUES
-- Cars
(gen_random_uuid(), 'Maruti Swift', 'Maruti Suzuki', 'HATCHBACK', 1200, 'Mumbai', 'AVAILABLE', '/images/swift.jpeg', '["Dual Airbags", "ABS with EBD", "Touchscreen Infotainment", "Steering Mounted Controls", "Rear Parking Sensors"]'::jsonb, 'The Maruti Swift is India\'s favourite hatchback, known for its sporty design and peppy performance.', 5, 'Petrol', 'Manual', 4.5, 328),
(gen_random_uuid(), 'Hyundai Creta', 'Hyundai', 'SUV', 2500, 'Bangalore', 'AVAILABLE', '/images/creta.jpg', '["Panoramic Sunroof", "Ventilated Seats", "Bose Sound System", "6 Airbags", "Wireless Charging"]'::jsonb, 'The Ultimate SUV. The Hyundai Creta offers a premium driving experience with feature-loaded interiors.', 5, 'Diesel', 'Automatic', 4.7, 412),
